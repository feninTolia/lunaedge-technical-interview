...
const ModalDialog = ({ title, ...attr }: IModalDialog) => {
      ...
      <>
        ...
        >
          <div className="flex justify-between">
            ...
            <button onClick={() => contextModal?.setIsModalOpen(false)}>
          ...
          <div className=" self-end flex gap-4">
            <button
              onClick={() => contextModal?.setIsModalOpen(false)}
              className="font-medium"
            >
              Cancel
            </button>
            <PrimaryButton onClick={() => contextModal?.setIsModalOpen(false)}>
              Save
            </PrimaryButton>
          </div>
        </div>
